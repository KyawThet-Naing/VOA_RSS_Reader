class NewsOb {
  ...
  NewsOb({this.status, this.feed, this.items});

  NewsOb.fromJson(Map<String, dynamic> json) {
    this.status = json['status'];
    this.feed = json['feed'] != null ? new Feed.fromJson(json['feed']) : null;
    if (json['items'] != null) {
      List<NewItems> items = [];
      json['items'].forEach((v) {
        items.add(new NewItems.fromJson(v));
      });
      this.items = items;
    }
  }
